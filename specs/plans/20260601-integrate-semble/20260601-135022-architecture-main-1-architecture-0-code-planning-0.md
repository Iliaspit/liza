...
**validation:** `go test ./internal/semble -run 'TestActivation|TestCommandPlan|TestDefaultIgnorePatterns'`
...
**validation:** `go test ./internal/semble -run 'TestValidation|TestReadinessCache|TestDiagnostics'`
...
**validation:** `go test ./internal/semble -run 'TestTargetSafety|TestPromptMetadata|TestShellQuotedCommands'`
...
Each coding task should validate its own behavior with focused Go tests:

- Task 1: `go test ./internal/semble -run 'TestActivation|TestCommandPlan|TestDefaultIgnorePatterns'`
- Task 2: `go test ./internal/semble -run 'TestValidation|TestReadinessCache|TestDiagnostics'`
- Task 3: `go test ./internal/semble -run 'TestTargetSafety|TestPromptMetadata|TestShellQuotedCommands'`
