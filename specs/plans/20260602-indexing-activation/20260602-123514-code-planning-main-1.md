...
| `internal/scipsearch/**` | Task 3 | Task 5, Task 7 | Task 5 depends on Task 3 |
| `internal/semble/**` | Task 4 | Task 5, Task 7 | Task 5 depends on Task 4 |
...
Task 6 can run independently because it owns MAS prompt gating and does not write files owned by pairing init tasks or consume Task 3/Task 4 pairing-only interfaces. Task 7 and Task 8 intentionally depend on implemented behavior to avoid tests/docs being written against planned-but-unmerged interfaces.
