...
func TestNonDefaultBrandRepairAgentPoolHelpDescribesClaimEligibleReviewerCapacity(t *testing.T) {
	bin := buildNonDefaultBrandBinary(t)
	help := runBrandSmokeCommand(t, bin, "repair-agent-pool", "--help")
	...
	for _, required := range []string{
		...
		assertContains(t, help, required)
	}
