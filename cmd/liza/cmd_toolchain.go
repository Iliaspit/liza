...
func init() {
	...
	registerCompletion(toolchainDoctorCmd, "profile", completeValues(string(toolchain.ProfileBalanced), string(toolchain.ProfileLean), string(toolchain.ProfileFull)))
	registerCompletion(toolchainInstallCmd, "profile", completeValues(string(toolchain.ProfileBalanced), string(toolchain.ProfileLean), string(toolchain.ProfileFull)))
	registerCompletion(toolchainConfigureCmd, "profile", completeValues(string(toolchain.ProfileBalanced), string(toolchain.ProfileLean), string(toolchain.ProfileFull)))
	registerCompletion(toolchainDoctorCmd, "include", completeToolIDs)
	registerCompletion(toolchainInstallCmd, "include", completeToolIDs)
	registerCompletion(toolchainConfigureCmd, "include", completeToolIDs)
