...
var atomicGenerationFenceInventory = []atomicFenceInventoryEntry{
	...
	{name: "claim-graph-replan", command: "claim-graph-replan", sourceFile: "cmd/liza/cmd_graph_replan.go", declaration: "claimGraphReplanCmd", call: "ops.ClaimGraphReplan", authorityBinding: "authority"},
	...
	{name: "complete-graph-replan", command: "complete-graph-replan", sourceFile: "cmd/liza/cmd_graph_replan.go", declaration: "completeGraphReplanCmd", call: "ops.CompleteGraphReplan", authorityBinding: "authority"},
...
func testE2EAtomicFenceInventory(t *testing.T) {
	expected := []string{
		...
		"cancel-task", "claim-degradation", "claim-doer", "claim-graph-replan", "claim-reviewer", "claim-task",
		"clear-claim-degradation", "complete-graph-replan", "handoff", "mark-blocked", "reconcile-merged",
